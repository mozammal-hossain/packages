...
See the [mustache manual]([http://mustache.github.com/mustache.5.html](http://mustache.github.com/mustache.5.html)) for detailed usage information.

This library passes all [mustache specification]([https://github.com/mustache/spec/tree/master/specs](https://github.com/mustache/spec/tree/master/specs)) tests.
...
```dart
  ...
  var t = Template('{{ [author.name](http://author.name) }}');
